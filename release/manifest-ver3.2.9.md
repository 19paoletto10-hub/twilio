...
1. `./scripts/prepare_release_bundle.sh ver3.2.9`
2. Zweryfikuj `release/dist/ver3.2.9/` (czy zawiera tylko wymienione ścieżki).
3. Spakuj katalog i załącz do GitHub Release `ver3.2.9 – Design patterns & performance suite`.
